...
The initial hand-authored motif is superseded for browser training by the shared
Xsens captured target: see docs/specs/continuous-training.md. Historical control
experiments keep their old reference and recorded results.
